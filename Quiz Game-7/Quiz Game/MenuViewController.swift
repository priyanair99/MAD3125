...
class MenuViewController: UIViewController {
    ...
    func layoutView() {
        ...
        logoView.image = UIImage(named: "play-logo")
        ...
        recentScoreLabel.text = "Scene-points: " + String(UserDefaults.standard.integer(forKey: multipleChoiceRecentscoreIdentifier))
        highscoreLabel.text = "High scene-points: " + String(UserDefaults.standard.integer(forKey: multipleChoiceHighscoreIdentifier))
    ...
    func nextScores() {
        ...
        UIView.animate(withDuration: 1.0, animations: { 
            ...
            self.view.layoutIfNeeded()
                ...
                self.recentScoreLabel.text = "Scene: " + String(self.recentScores[self.scoreIndex])
